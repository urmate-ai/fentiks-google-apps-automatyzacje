...
Automatyzacja odświeża dane w Vertex AI Search (data store) dla firmy Fentix. Skrypt Google Apps Script monitoruje wskazany folder na Dysku Google i co 30 minut wysyła listę plików do ponownego zaindeksowania w usłudze Vertex AI Search.
...
4. `04_vertex.js` – budowanie żądań i sprawdzanie statusu operacji Vertex AI Search.
